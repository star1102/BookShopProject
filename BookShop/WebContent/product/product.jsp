										...
										<td height="5">
											...
											<%
												if(Smenu.equals("1")){			//qna
														if(mode.equals("l")){
											%>
														<jsp:include page="/product/module/cateList.jsp" />
											<%		
														}else if(mode.equals("w")){
											%>
														<jsp:include page="/product/module/cateWrite.jsp" />
											<%
														}
												}else if(Smenu.equals("2")){	//faq
														if(mode.equals("l")){
											%>
														<jsp:include page="/product/module/prodList.jsp" />
											<%		
														}else if(mode.equals("w")){
											%>			
														<jsp:include page="/product/module/prodWrite.jsp" />
											<%	
														}else if(mode.equals("r")){
											%>
														<jsp:include page="/product/module/prodView.jsp" />
											<%
														}
												}
											%>
