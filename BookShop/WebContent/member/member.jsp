								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td height="5">
											<!--콘텐츠가 들어가는 테이블 시작 --><br>
											<%
												if(Smenu.equals("1")){ //관리자 회원관리
													if(mode.equals("l")){
											%>
														<jsp:include page="/member/module/adminList.jsp" />
											<%		
													}else if(mode.equals("w")){
											%>
														<jsp:include page="/member/module/adminWrite.jsp" />
											<%
													}
												}else if(Smenu.equals("2")){ //일반회원 관리
											%>
													<jsp:include page="/member/module/publicList.jsp" />
											<%		
												}
											%>
											<!--콘텐츠가 들어가는 테이블 끝 --></td>
